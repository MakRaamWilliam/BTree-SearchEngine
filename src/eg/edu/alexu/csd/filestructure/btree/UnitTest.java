...
//	 */
	...
	public void testindexDirectorySimple() {
		...
		try {
			...
			List<ISearchResult> actual = searchEngine.searchByWordWithRanking("      TEstWordNotExist       ");
			for (ISearchResult searchRes : actual) {
	...
	public void testindexWebDirectoryComplex() {
		...
		try {
			...
			List<ISearchResult> actual = searchEngine.searchByWordWithRanking("   trOUbleshOoting    ");
			for (ISearchResult searchRes : actual) {
				System.out.println(searchRes.toString());
			}
			Collections.sort(actual, new Comparator<ISearchResult>() {
...
//	 */
	...
	public void testDeleteWebPageSimple() {
		...
		try {
			...
			List<ISearchResult> expected = Arrays.asList(new SearchResult[]{new SearchResult("7702780", 1)});
			List<ISearchResult> actual = searchEngine.searchByWordWithRanking("   tRAcerOUte   ");
			for (ISearchResult searchRes : actual) {
		//		System.out.println(searchRes.toString());
			}
			Collections.sort(actual, new Comparator<ISearchResult>() {
...
//	@SuppressWarnings("unchecked")
	...
	public void testsearchByMultipleWordWithRanking() {
		...
		try {
			searchEngine.indexDirectory("res");
			List<ISearchResult> expected = Arrays.asList(new SearchResult[]{new SearchResult("7738356", 1), new SearchResult("7738825", 1)});
			List<ISearchResult> actual = searchEngine.searchByMultipleWordWithRanking(" may reFEr     TO 	");
			for (ISearchResult searchRes : actual) {
				System.out.println(searchRes.toString());
			}
			Collections.sort(actual, new Comparator<ISearchResult>() {
